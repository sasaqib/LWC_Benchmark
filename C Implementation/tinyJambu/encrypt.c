...
// int main(){
//         // // Test State Update Function For Verilog
//         // unsigned int state [4] = {};
//         // const unsigned char key[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F}; // 128-bit key
//         // printf("State Before Update = \n");
//         // for (int i = 0; i < 4; i++)
//         // {
//         //         printf("%02X\n", state[i]);
//         // }
//         // state_update(state, key, 128);
